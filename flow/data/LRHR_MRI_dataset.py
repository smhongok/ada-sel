...
class LRHR_MRIDataset(data.Dataset):
    def __init__(self, opt, divide_freq):
        super(LRHR_MRIDataset, self).__init__()
        self.opt = opt
        ...
        lr_file_path = opt["dataroot_GT"] + "/../LR/"
        ...
        self.lr_paths = fiFindByWildcard(os.path.join(lr_file_path, '*.png'))
        t = time.time() - t
